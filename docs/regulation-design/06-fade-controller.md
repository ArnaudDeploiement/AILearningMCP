...
>
> Resout les findings F-4.2 (`autonomy_score` calcule mais non
> consomme) et F-4.8 (intent design "le systeme se rend
> progressivement inutile" sans implementation).
>
...
- [ ] commit message cite F-4.2, F-4.8 et lie ce design doc
...
| **Findings resolus** | F-4.2, F-4.8 (sous flag ON) |
